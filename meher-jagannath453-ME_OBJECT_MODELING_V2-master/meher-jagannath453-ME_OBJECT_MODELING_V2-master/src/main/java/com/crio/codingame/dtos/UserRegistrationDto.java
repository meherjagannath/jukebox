...
public class UserRegistrationDto {
    ...
    public UserRegistrationDto(String contestName, String userName,
    ...
    public String toString() {
        return "RegisterContestDto [contestName=" + contestName + ", registerationStatus="
                + registerationStatus + ", userName=" + userName + "]";
    }
