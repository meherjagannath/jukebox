...
public class ApplicationConfig {
        ...
        private final IPlaylistService playlistService =
                        new PlaylistServiceImpl(playlistRepository, songRepository, userRepository);
        private final ISongService songService =
                        new SongServiceImpl(songRepository, userRepository);
        ...
        private final ModifyPlaylistAddSongCommand modifyPlaylistAddSongCommand =
                        new ModifyPlaylistAddSongCommand(playlistService);
        private final ModifyPlaylistDeleteSongCommand modifyPlaylistDeleteSongCommand =
                        new ModifyPlaylistDeleteSongCommand(playlistService);
        ...
        public CommandInvoker getCommandInvoker() {
                ...
                commandInvoker.register("ADD-SONG", modifyPlaylistAddSongCommand);
                commandInvoker.register("DELETE-SONG", modifyPlaylistDeleteSongCommand);
