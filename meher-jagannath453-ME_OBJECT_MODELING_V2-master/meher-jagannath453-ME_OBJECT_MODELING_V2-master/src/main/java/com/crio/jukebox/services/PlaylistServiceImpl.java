...
public class PlaylistServiceImpl implements IPlaylistService {
        ...
        for (String id : songId) {
            ...
            if (song.equals(Optional.empty())) {
                throw new SongNotAvailableException(
                        "Some songs requested are not available in the pool");
            }
    ...
    @Override
    public String modifyPlaylist(String message, String userId, String playlistId,
            List<String> songId) {
    ...
    private String addSongToPlaylist(User user, Playlist playlist, List<String> songId) {
    ...
    private String deleteSongFromPlaylist(User user, Playlist playlist, List<String> songId) {
    ...
    public String playPlaylist(String userId, String playlistId) {
        ...
        Playlist playlist = uPlaylists.stream().filter(p -> p.getId().equals(playlistId)).findAny()
                .orElse(null);
        ...
        // SongDto songDto = new SongDto("Current Song Playing.", songName, albumName,
        // featuredArtists);
